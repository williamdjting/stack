...
export default async function generateResume(aiResponse: Record<string, any>) {
	...
	function parseProjectJsonToParagraphs(data: { projects: any[] }) {
			...
			if (data.projects && Array.isArray(data.projects)) {
				...
				data.projects.forEach((project) => {
					...
					if (
						...
						project.project_details.forEach(
							(detail: { project_bullets: any }) => {
			...
			if (data.work_experience && Array.isArray(data.work_experience)) {
				...
				data.work_experience.forEach((experience) => {
					...
					if (
						...
						experience.workexperience_details.forEach(
							(detail: { workexperience_bullets: any }) => {
